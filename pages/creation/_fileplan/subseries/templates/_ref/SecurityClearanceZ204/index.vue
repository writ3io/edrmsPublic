                        ...
                        <v-card>
                            ...
                            <v-card-text class="pt-0 mt-0">
                                ...
                                <br/>
                                 ...
                                 <v-layout xs12 wrap border class="card-border">
                                      <v-flex xs12>
                                        <v-text-field v-model="doc.body.initialsSurname" label="NAME OF IMMEDIATE SUPERVISOR/DELEGATED OFFICIAL: "></v-text-field>
                                      </v-flex>
                                      <v-flex xs12 lg6>
                                ...
                                <v-layout xs12 wrap border class="card-border">
                                    ...
                                    <v-flex>
                                        <ol>
                                            ...
                                            <li>The names of the President, members of the Cabinet, members of Parliament, jurists, physicians as well as ,managing directors of large institutions must preferably not be given as references, because the clearing
                                            institutions conduct interviews with every reference during their investigation, and their busy programmes should not be encroached upon.</li>
                                            <li>Please attach the following items to this questionnaire when completed:</p>
                                        <ul>
...
<template v-slot:items="props" v-slot:no-data>
    ...
    <td class="px-0 py-0">
        <v-menu v-model="menu1a" :close-on-content-click="false" :nudge-right="40" transition="scale-transition" offset-y min-width="290px">
            <template v-slot:activator="{ on }">
...
<template v-slot:no-data>
    <div :value="true" class="text-xs-center">
        No Form Input Fields</div>
                ...
                <v-card-text class="pt-0 mt-0">
                <h4>2.	RESIDENTIAL ADDRESSES</h4>
                KINDLY FURNISH THE FOLLOWING PARTICULARS REGARDING YOUR CURRENT AND PREVIOUS ADDRESSES
                <v-layout xs12 wrap border>
                  <v-flex>
...
<template v-slot:no-data>
    <div :value="true" class="text-xs-center">
        No Form Input Fields</div>
                ...
                <v-card-text class="pt-0 mt-0">
                <h4>3. EDUCATIONAL QUALIFICATIONS</h4>
                KINDLY FURNISH THE FOLLOWING PARTICULARS REGARDING ALL SECONDARY AND TERTIARY EDUCATIONAL INSTITUTIONS          
...
<template v-slot:items="props" v-slot:no-data>
    ...
    <td>
        <v-text-field v-model="props.item.comment" solo flat placeholder class="styled-input"></v-text-field>
    </td>
...
<template v-slot:items="props" v-slot:no-data>
    <td class="px-0 py-0">
        <v-text-field v-model="props.item.description" single-line solo flat placeholder></v-text-field>
    </td>
    <td class="px-0 py-0">
...
<template v-slot:items="props" v-slot:no-data="Hello">
    <td class="text-xs-center">
        <v-text-field v-model="props.item.relationship" single-line solo flat placeholder="Relationship"></v-text-field>
    </td>
    <td class="text-xs-right px-0 py-0">
        <v-text-field v-model="props.item.presentSurname" single-line solo flat placeholder="Present Surname"></v-text-field>
    </td>
    <td class="text-xs-right px-0 py-0">
        <v-text-field v-model="props.item.previousSurname" single-line solo flat placeholder="Performance Indicator"></v-text-field>
    </td>
    <td class="text-xs-right px-0 py-0">
        <v-text-field v-model="props.item.firstNames" single-line solo flat placeholder="First Names"></v-text-field>
    </td>
    <td class="text-xs-right px-0 py-0">
        <v-text-field v-model="props.item.identityNumber" single-line solo flat placeholder="Identity Number"></v-text-field>
    </td>
    <td class="text-xs-right px-0 py-0">
        <v-text-field v-model="props.item.countryOfBirth" single-line solo flat placeholder="Country Of Birth"></v-text-field>
    </td>
    <td class="text-xs-right px-0 py-0">
        <v-text-field v-model="props.item.nationality" single-line solo flat placeholder="Nationality"></v-text-field>
    </td>
    <td class="text-xs-right px-0 py-0">
        <v-text-field v-model="props.item.fullResidentialAddress" single-line solo flat placeholder="Full Residential Address"></v-text-field>
    </td>
    <td class="text-xs-center px-0 py-0">
        <v-icon small color="red " @click="removeRow(props.index)">delete</v-icon>
    </td>
...
export default {
    ...
    data() {
        return {
            ...
            headers1: [{
                text: "IF YOUR ANSWER TO ANY OF THE ABOVE QUESTIONS IS ‘YES’, STATE THE FOLLOWING",
                align: "center",
                sortable: false,
                value: ""
                //   width: "10%"
            ...
            headers6: [{
                text: "KINDLY PROVIDE THE FOLLOWING PARTICULARS OF YOUR PREVIOUS SPOUSE(S)/OR COHABITANTS",
                align: "center",
                sortable: false,
                value: ""
                //   width: "10%"
            ...
            headers: [{
                    text: "KINDLY PROVIDE THE FOLLOWING PARTICULARS I.R.O YOUR SPOUSE OR COHABITANT",
                    align: "left",
                    sortable: false,
                    value: ""
                    //   width: "10%"
            ...
            headers18: [{
                text: "IF YOUR  ANSWER TO THE ABOVE QUESTION IS ‘YES’, STATE THE FOLLOWING",
                align: "center",
                sortable: false,
                value: ""
                //   width: "10%"
            ...
            headers20: [{
                text: "IF YOU HAVE EVER HAD A SUMMONS SERVED ON YOU FOR DEBT, STATE THE FOLLOWING",
                align: "center",
                sortable: false,
                value: ""
                //   width: "10%"
            ...
            doc: {
                ...
                body: {
                    ...
                    items1: ['SINGLE', 'MARRIED', 'SEPARATED', 'DIVORCED', 'WIDOW/WIDOWER', 'COHABITING'],
                    ...
                    phase2: [{
                        description: "HAVE YOU EVER UNDERGONE PSYCHIATRIC TREATMENT AND/OR PSYCHOLOGICAL THERAPY?",
                        boolean: "",
                        comment: ""
                    }],
                    ...
                    phase15: [{
                        description: "DO YOU HAVE A PERMANENT RESIDENCE PERMIT FOR THE RSA?",
                        boolean: "",
                        comment: ""
                    }],
                    phase20: [{
                        description: "HAVE YOU EVER BEEN CONVICTED OR ARE THERE ANY PENDING CASES FOR A CRIMINAL/ DEPARTMENTAL OFFENCE(S)? ( ADMISSION OF GUILT OUTSIDE A COURT MUST ALSO BE SUBMITTED )",
                        boolean: "",
                        comment: ""
                    }],
                    phase21: [{
