              ...
              <hr style="color:grey" />
                ...
                <v-layout wrap>
                    <v-flex xs12>
                        ...
                        <v-card>
                            <br/>
                                ...
                                <p class="text-xs-center"><strong>CERTIFICATE PROTECTION OF INFORMATION ACT, 84 OF 1982</strong></p>
                   ...
                   <v-layout xs12 wrap>
                    ...
                    <v-flex xs12 lg4>
                      <v-text-field v-model="doc.body.initialsSurname" label="(Identity Number): "></v-text-field>
                    </v-flex>
                    <v-flex xs12 lg3>
                      <v-text-field v-model="doc.body.initialsSurname" label="(Persal Number): "></v-text-field>
                    </v-flex>
                   ...
                   <br/>
                                ...
                                <v-layout xs12 wrap border class="card-border">
                                        ...
                                        <ol>
                                            ...
                                            <li>I understand that the said provisions and instructions shall apply not only during my term of office but also after the termination of my services with the Department; and
                                                <ul>
...
<template v-slot:activator="{ on }">
 ...
 <v-flex xs12 lg5>
    <v-text-field v-model="doc.body.initialsSurname" label="Witness 1: "></v-text-field>
    </v-flex>
...
<template v-slot:activator="{ on }">
    ...
    <v-flex xs12 lg5>
        <v-text-field v-model="doc.body.initialsSurname" label="Witness 2: "></v-text-field>
</v-flex>
...
<i><u>Issued by:</u> Security Management,<br>
                Department of Education: Limpopo</i>
