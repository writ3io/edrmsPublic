...
<template v-slot:items="props" v-slot:no-data>
    <td class>
        <v-text-field v-model="props.item.lotNo" single-line solo flat placeholder="Lot No"></v-text-field>
    </td>
    <td class>
        <v-text-field v-model="props.item.regNo" single-line solo flat placeholder="Reg. No"></v-text-field>
    </td>
    <td class>
        <v-text-field v-model="props.item.make" single-line solo flat placeholder="Make"></v-text-field>
    </td>
    <td class="px-0 py-0">
        <v-text-field v-model="props.item.model" single-line solo flat placeholder="Model "></v-text-field>
    </td>
    <td class="px-0 py-0">
        <v-text-field v-model="props.item.assetNo" single-line solo flat placeholder="Asset No"></v-text-field>
    </td>
    <td class="px-0 py-0">
        <v-text-field v-model="props.item.colour" single-line solo flat placeholder="Colour"></v-text-field>
    </td>
    <td class="px-0 py-0">
        <v-text-field v-model="props.item.kilos" single-line solo flat placeholder="Kilos"></v-text-field>
    </td>
    <td class="px-0 py-0">
        <v-text-field v-model="props.item.purchasePrice" single-line solo flat placeholder="Purchase Price"></v-text-field>
    </td>
    <td class="px-0 py-0">
        <v-text-field v-model="props.item.reservedPrice" single-line solo flat placeholder="Reserved Price"></v-text-field>
    </td>
    <td class="px-0 py-0">
        <v-text-field v-model="props.item.engineNo" single-line solo flat placeholder="Engine No"></v-text-field>
    </td>
    <td class="px-0 py-0">
        <v-text-field v-model="props.item.chasisNo" single-line solo flat placeholder="Chasis No"></v-text-field>
    </td>
    <td class="px-0 py-0">
        <v-text-field v-model="props.item.remarks" single-line solo flat placeholder="Remarks"></v-text-field>
    </td>
