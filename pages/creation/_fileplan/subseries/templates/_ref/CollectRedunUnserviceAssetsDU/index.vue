      ...
      <v-flex xs9>
        ...
        <v-layout wrap>
          <v-flex xs12>
            ...
            <h4 class="text-xs-left">VERIFICATION AND COLLECTION OF REDUNDANT/UNSERVICEABLE ASSETS BY DISPOSAL UNIT</h4>
            <br />
            <v-card>
              <v-card-title>
                <v-flex xs12 lg6>
                  <v-text-field v-model="doc.body.initialsSurname" label="NAME OF INSTITUTION: "></v-text-field>
                  </v-flex>
                  ...
                  <v-flex>
                    ...
                    >
                      ...
                      <template v-slot:items="props" v-slot:no-data="">
                        ...
                        <td class>
                          <v-text-field v-model="props.item.assetNo" single-line
                            solo
                            flat
                            placeholder="Asset No"></v-text-field>
                        </td>
                        <td class>
                            <v-text-field v-model="props.item.descriptionOfAsset" single-line
                            solo
                            flat
                            placeholder="Description Of Asset"></v-text-field>
...
export default {
  ...
  methods: {
    ...
    addRow() {
      this.doc.body.phase1.push({});
    },
    removeRow(index) {
      this.doc.body.phase1.splice(index, 1);
    }
  },
