                  ...
                  <v-flex xs12>
                    ...
                    >
                      <template v-slot:activator="{ on }">
                          <strong>LIST OF GOVERNMENT VEHICLES TO BE DISPOSED FOR THE FINANCIAL YEAR :</strong> {{doc.body.date1}}
                      </template>
                    ...
                    <v-flex>
                      ...
                      >
                        ...
                        <template v-slot:items="props" v-slot:no-data>
                          ...
                          <td>
                            {{props.item.purchasePrice}}
                          </td>
                          <td>
                            {{props.item.reservedPrice}}
                          </td>
                          <td>
                            {{props.item.engineNo}}
                          </td>
