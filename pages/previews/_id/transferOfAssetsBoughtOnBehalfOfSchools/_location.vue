        ...
        <v-layout wrap>
          <v-flex xs12>
            ...
            <v-layout wrap justify-right>
                <v-flex xs12>
                <strong>NAME OF INSTITUTION / DISTRICT :</strong>{{doc.body.branch}}
              </v-flex>
              <v-flex xs12>
          ...
          <v-flex xs12>
            ...
            <v-data-table :headers="headers" :items="doc.body.tr" hide-actions class="elevation-1">
              ...
              <template v-slot:items="props" v-slot:no-data="">
                ...
                <td>
                  {{props.item.oldLocation}}
                </td>
                <td >
                  {{props.item.newLocation}}
                </td>
                <td>
                  {{props.item.reasonForTransfer}}
                </td>
                <td>
                  {{props.item.dateTransferred}}
                </td>
