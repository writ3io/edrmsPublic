    ...
    <v-container grid-list-md>
        <v-layout justify-space-between>
            ...
            <v-flex xs9>
                <v-layout wrap>
                    <v-flex xs12>
                        ...
                        <v-layout wrap>
                            <v-flex xs6>
                                <p><strong>Our ref: </strong>{{doc.ref}}</p>
                            </v-flex>
                            <v-flex xs6>
                                 <p><strong>Enquiries: </strong>{{doc.body.rfq}}</p>
                            </v-flex>
                            <v-flex xs6>
                                <p><strong>Telephone: </strong>{{doc.body.tel}}</p>
                            </v-flex>
                            <v-flex xs6>
                                <p><strong>Email: </strong>{{doc.body.email}}</p>
                            </v-flex>
                        </v-layout>
                    </v-flex>
          ...
          <v-flex xs12>
            ...
            <p>2. Your security clearance is valid for a period of five <u>{{doc.body.period}}</u> years and will expire on the 
           <u>{{doc.body.date1}}</u>
